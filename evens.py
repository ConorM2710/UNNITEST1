def even_number_of_evens(numbers):
    """
    Should raise a TypeError if a list not apssed into the function
    errormessage: "A list was not passed into the function"
    ...
    if isinstance(numbers, list):
        ...
        raise TypeError("A list was not passed into the funtion")
